    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="mt-16">
                    <h1 class="text-3xl md:text-4xl text-white text-center font-bold mb-10">ALL STUDENTS LISTS</h1>
                    <div class="mb-5 flex justify-end items-center">
                        <a href="/dashboard" id="myAnchorTag" class="mr-5 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
                            </svg>                              
                        </a>
                        <label for="table-search" class="sr-only">Search</label>
                        <form action="{{ route('search-welcome') }}" method="GET">
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
                                </div>
                                <input type="text" id="search-results" name="search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full sm:w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for users">
                            </div>
                        </form>
                    </div>
                                ...
                                <div>
                                    <div class="flex items-center justify-center">
                                        <div class="rounded-full">
                                            <img src="{{ asset('storage/images/' . $student->studentImage) }}" alt="" width="100" height="100" class="h-auto max-w-full rounded-full">
                                        </div>
    
                                        <div class="ms-5">
                                            <h2 class="text-xl font-semibold text-gray-900 dark:text-white">{{ $student->fName}} {{ substr($student->mName, 0, 1) }}. {{ $student->lName }}</h2>
                                            <div class="mt-1">
                                                ...
                                                @elseif ($student->enrolled === 'Not Enrolled')
                                                ...
                                                @elseif ($student->enrolled === 'Pending')
